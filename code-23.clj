...
(def rooms ; global. if it changes in part 2, i'll deal w/that then
  {1  {:id 1,  :nbs [2],       :home 'hallway}
   ...
   13 {:id 13, :nbs [12],      :home 'a, :endpoint true}
   14 {:id 14, :nbs [5 15],    :home 'b}
   15 {:id 15, :nbs [14],      :home 'b, :endpoint true}
   16 {:id 16, :nbs [7 17],    :home 'c}
   17 {:id 17, :nbs [16],      :home 'c, :endpoint true}
   18 {:id 18, :nbs [9 19],    :home 'd}
   19 {:id 19, :nbs [18],      :home 'd, :endpoint true}
   })
...
(def ptest
  {0 {:me 'a, :in 12, :spent 0, :cost 10}
   1 {:me 'a, :in 13, :spent 0, :cost 1}
   2 {:me 'b, :in 4, :spent 0, :cost 100}
   3 {:me 'b, :in 16, :spent 0, :cost 1000}
   4 {:me 'c, :in 14,  :spent 0, :cost 10}
   5 {:me 'c, :in 17, :spent 0, :cost 100}
   6 {:me 'd, :in 1, :spent 0, :cost 1000}
   7 {:me 'd, :in 15, :spent 0, :cost 1}})

;(print-pods ptest)
;(prn (unfiltered-destinations (ptest 3) ptest))
;(prn (filtered-destinations (ptest 3) ptest))

;(prn (unfiltered-destinations (ptest 2) ptest))
;(prn (filtered-destinations (ptest 2) ptest))
